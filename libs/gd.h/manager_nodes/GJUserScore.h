...
namespace gd {
    class GJUserScore : public cocos2d::CCNode {
        ...
        //    inline int getModBadge() const { return this->modBadge_; }

    public:
        const char* userNameChar_;
        std::string userName_;
        std::string userUDID_;
        int scoreType_; // legacy field, used in 1.9 to determine shown info
        int userID_;
    ...
    public:
        ...
        inline std::string getPlayerName() const { return this->userName_; };
        inline const char* getPlayerNameChar() const { return this->userNameChar_; };

        inline void setPlayerCube(int cube) { this->playerCube_ = cube; };
        inline void setPlayerName(std::string name) { this->userName_ = name; };
        inline void setPlayerNameChar(const char* name) { this->userNameChar_ = name; };
        inline void setUserID(int userID) { this->userID_ = userID; };
        inline void setAccountID(int accountID) { this->accountID_ = accountID; };
        inline void setBadgeLevel(int bl) { this->modBadge_ = bl; };
        inline int getModBadge() const { return this->modBadge_; };
    };
}
